...
var user = {"userid" : 1, "attributes": [1,2,3,4,5]};
var rest = [{"userid" : 2, "attributes": [1,1,1,1,1]},
...
console.log(Algo.MostDifferent(user, rest));

console.log(Algo.MostSimilar(user, rest));